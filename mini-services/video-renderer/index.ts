...
const ContentBlockSchema = z.discriminatedUnion('type', [
  ...
  z.object({
    ...
    backgroundPreset: z.enum([
      'none', 'cyber-grid', 'mountain-range', 'ocean-waves', 'forest-trees', 'city-skyline',
      'abstract-waves', 'space-station', 'aurora-borealis', 'volcanic-inferno', 'crystal-caves',
      'desert-dunes', 'neon-tokyo', 'floating-islands', 'deep-ocean', 'galaxy-nebula',
      'matrix-rain', 'ice-glacier', 'steampunk-gears', 'alien-planet', 'tron-grid',
      'football-stadium', 'race-track', 'concert-stage', 'castle-grounds', 'airport-runway',
      'theme-park', 'ancient-ruins', 'zen-garden', 'ski-resort', 'vineyard',
      'underwater-kingdom', 'cyberpunk-city', 'medieval-arena', 'space-colony', 'tropical-beach',
    ]).default('cyber-grid'),
